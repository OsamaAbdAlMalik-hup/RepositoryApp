            ...
            actions: [
                ...
                child: IconButton(
                  onPressed: () async {
                    HelperDesignFunctions.showAwesomeDialog(context,
                        ...
                        btnCancelOnPress: () {},
                        body: SortDialog<ProductsController>(
                          title: "Sort Product",
              ...
              Visibility(
                  ...
                  child: TabBarView(
                    ...
                    children: List.generate(controller.sortItems.length-1, (index) => Text(index.toString()),),
                  ))
            ],
                            ...
                            itemBuilder: (context, index) => Slidable(
                              ...
                              endActionPane: ActionPane(
                                ...
                                children: [
                                  SlidableAction(
                                    onPressed: (c) async {
                                      controller.showSheetUpdateProduct(context,
                                          product: controller.products[index]);
                                    },
