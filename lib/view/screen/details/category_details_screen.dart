...
import 'package:repository/view/widget/shared/nested_scroll_view_page.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CategoryDetailsController>(
      builder: (controller) => NestedScrollViewPage(
        title: "${HelperLogicFunctions.upperFirstChar(controller.category.name)} Category",
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(context)
                      ...
                      .bodyMedium!
                      .copyWith(
                      color: AppColors.primary70, fontSize: 24),
                )
              ],
            ),
              ...
              itemBuilder: (context, index) => Card(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Get.toNamed(AppPagesRoutes.productDetailsScreen,
                        arguments: {
                          AppSharedKeys.passId: controller.category
                              .details.purchases[index].productId
                        });
                  },
                  child: Padding(
                    padding: const EdgeInsets.all(10),
